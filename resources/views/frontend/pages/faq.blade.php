...
@section('title','Otaku Haven || FAQ - Frequently Asked Questions')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html">Frequently Asked Questions</a></li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <section id="faq-section">
        ...
        <div class="faq-container">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p> Yes! We offer international shipping.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>You can reach out to our customer support team via our Contact Us page or by sending an email to bibimeowotakuhaven@gmail.com.</p>
                </div>
            </div>
